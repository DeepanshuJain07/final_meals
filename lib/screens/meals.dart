...
class MealsScreen extends StatelessWidget {
  ...
  void selectMeal(BuildContext context,Meal meal1){
    Navigator.of(context).push(MaterialPageRoute(builder:(ctx)=>MealDetailsScreen(meal: meal1,)),);
  ...
  Widget build(BuildContext context) {
    ...
    if (meals.isNotEmpty) {
      content = ListView.builder(
        itemCount: meals.length,// iski vajah se hi hume melas Text screen pe dikhga otherwise nahi dikhega.
